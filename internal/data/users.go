...
/*
La méthode Matches() vérifie si le mot de passe en texte brut fourni correspond au
mot de passe haché stocké dans la structure, renvoyant vrai s'il correspond et faux
sinon.
*/
